  ...
  return (
    <>
      ...
      <main className="container mx-auto py-16 px-4">
        ...
        <h2 className="text-2xl font-semibold mt-8">Einleitung</h2>
        <p className="mb-4">
          ...
          Begriffe sind nicht geschlechtsspezifisch. Stand: 3. Juli 2020
        </p>

        <h2 className="text-2xl font-semibold mt-8">Inhaltsübersicht</h2>
        ...
        <p>
          Son Hai Vu,
          <br />
          Stuttgarter Str. 134, 73312 Geislingen
          <br />
          E-Mail:{" "}
          <a
            href="mailto:sv058@hdm-stuttgart.de"
            className="text-accent underline"
          >
            sv058@hdm-stuttgart.de
          </a>
        </p>
        ...
        <h3 className="text-xl font-semibold mt-6">Zwecke der Verarbeitung</h3>
        ...
        <h3 className="text-xl font-semibold mt-6">Nationale Datenschutzregelungen in Deutschland:</h3>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8">Sicherheitsmaßnahmen</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          den gesetzlichen Vorgaben. Vorbehaltlich ausdrücklicher Einwilligung
          oder vertraglich oder gesetzlich erforderlicher Übermittlung
          verarbeiten oder lassen wir die Daten nur in Drittländern mit einem
          anerkannten Datenschutzniveau, zu denen die unter dem "Privacy-Shield"
        ...
        <h3 className="text-xl font-semibold mt-6">Einsatz von Cookies</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6">Speicherdauer:</h3>
        <p className="mb-4">
          Sofern wir Ihnen keine expliziten Angaben zur Speicherdauer von
          permanenten Cookies mitteilen (z. B. im Rahmen eines sog.
          Cookie-Opt-Ins), gehen Sie bitte davon aus, dass die Speicherdauer bis
        ...
        <h3 className="text-xl font-semibold mt-6">Kontaktaufnahme</h3>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8">Begriffsdefinitionen</h2>
        <p className="mb-4">
